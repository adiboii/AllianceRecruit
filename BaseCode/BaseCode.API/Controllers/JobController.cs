...
namespace BaseCode.API.Controllers
{
    public class JobController
    {
        ...
        public class JobDescriptionController : ControllerBase
        {
            ...
            public JobDescriptionController(IJobService jobService, IMapper mapper)
            {
            ...
            {
                var personalInformation = _jobService.FindJob(Id);
                return personalInformation != null ? Helper.ComposeResponse(HttpStatusCode.OK, personalInformation) : Helper.ComposeResponse(HttpStatusCode.NotFound, Constants.Job.JobDoesNotExist);
            }
